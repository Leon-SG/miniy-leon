...
export const INITIAL_STORE_CONFIG: StoreConfiguration = {
  ...
  products: [
    { 
      ...
      description: "Next-gen flagship noise-cancelling headphones with dual-chip noise cancellation system, 40-hour battery life, and Hi-Res Audio certified sound quality.", 
      price: 2999.00, 
      imageUrl: "https://picsum.photos/seed/sony_xm5/400/300", 
    ...
    { 
      id: '2', 
      name: "World of Warcraft - Horde Emblem Necklace", 
      description: "Exquisitely crafted silver Horde emblem necklace, perfectly recreating the iconic design from the game. Includes a premium collector's box.", 
      price: 299.00, 
      imageUrl: "https://picsum.photos/seed/wow_horde_necklace/400/300", 
      category: "WoW Merch", 
      sku: "WOW-HORDE-001", 
      stockQuantity: 100, 
      tags: ["wow", "horde", "necklace", "collectible", "gaming"], 
      isFeatured: true, 
      isPublished: true 
    },
    { 
      ...
      description: "Featuring the H2 chip, spatial audio support, enhanced active noise cancellation, and USB-C charging port.", 
      price: 1999.00, 
      imageUrl: "https://picsum.photos/seed/airpods_pro2/400/300", 
      category: "Electronics", 
      sku: "APPLE-AP2-001", 
      stockQuantity: 80, 
      tags: ["airpods", "wireless", "apple", "earbuds", "noise-cancelling"], 
      isFeatured: false, 
      isPublished: true 
    },
    { 
      id: '4', 
      name: "World of Warcraft - Alliance Emblem Pin", 
      description: "Premium alloy-crafted Alliance emblem pin, perfect for collection or daily wear.", 
      price: 199.00, 
      imageUrl: "https://picsum.photos/seed/wow_alliance_pin/400/300", 
      category: "WoW Merch", 
      sku: "WOW-ALLIANCE-001", 
      stockQuantity: 150, 
      tags: ["wow", "alliance", "pin", "collectible", "gaming"], 
      isFeatured: false, 
      isPublished: true 
    },
    { 
      ...
      description: "Powered by Snapdragon 8 Gen 3 processor, 200MP main camera, S Pen support, and titanium frame.", 
      price: 9999.00, 
      imageUrl: "https://picsum.photos/seed/s24_ultra/400/300", 
      category: "Electronics", 
      sku: "SAMSUNG-S24U-001", 
      stockQuantity: 30, 
      tags: ["smartphone", "samsung", "android", "flagship", "5g"], 
      isFeatured: true, 
      isPublished: true 
    },
    { 
      id: '6', 
      name: "World of Warcraft - Frostmourne Replica", 
      description: "1:1 scale replica of Frostmourne, crafted from premium metal materials. Includes display stand.", 
      price: 1299.00, 
      imageUrl: "https://picsum.photos/seed/wow_frostmourne/400/300", 
      category: "WoW Merch", 
      sku: "WOW-FROST-001", 
      stockQuantity: 20, 
      tags: ["wow", "frostmourne", "sword", "collectible", "gaming"], 
      isFeatured: true, 
      isPublished: true 
    },
    { 
      ...
      description: "Professional wireless mouse with 8000 DPI sensor, MagSpeed electromagnetic scroll wheel, and multi-device switching support.", 
      price: 899.00, 
      imageUrl: "https://picsum.photos/seed/mx_master3s/400/300", 
      category: "Electronics", 
      sku: "LOGITECH-MX3S-001", 
      stockQuantity: 60, 
      tags: ["mouse", "wireless", "logitech", "gaming", "productivity"], 
      isFeatured: false, 
      isPublished: true 
    },
    { 
      id: '8', 
      name: "World of Warcraft - Shadowlands Art Book", 
      description: "Collector's edition art book featuring stunning concept art from the Shadowlands expansion. Includes digital download code.", 
      price: 399.00, 
      imageUrl: "https://picsum.photos/seed/wow_artbook/400/300", 
      category: "WoW Merch", 
      sku: "WOW-ART-001", 
      stockQuantity: 40, 
      tags: ["wow", "artbook", "collectible", "gaming", "limited"], 
      isFeatured: false, 
      isPublished: true 
    },
    { 
      ...
      description: "Powered by M3 Pro chip, 14-inch Liquid Retina XDR display, 18GB unified memory, and 512GB SSD.", 
      price: 14999.00, 
      imageUrl: "https://picsum.photos/seed/mbp14_m3/400/300", 
      category: "Electronics", 
      sku: "APPLE-MBP14-001", 
      stockQuantity: 25, 
    ...
    { 
      id: '10', 
      name: "World of Warcraft - Hearthstone Card Set", 
      description: "Includes 100 premium cards, custom card sleeves, collector's box, and exclusive card back design.", 
      price: 599.00, 
      imageUrl: "https://picsum.photos/seed/wow_hearthstone/400/300", 
      category: "WoW Merch", 
      sku: "WOW-HS-001", 
      stockQuantity: 70, 
      tags: ["wow", "hearthstone", "cards", "collectible", "gaming"], 
      isFeatured: false, 
      isPublished: true 
    },
  ],
